...
LABEL readme='https://github.com/srmainwaring/blueos-micro-ros-agent/blob/main/README.md'
LABEL links='{\
        "source": "https://github.com/srmainwaring/blueos-micro-ros-agent"\
    }'
LABEL requirements="core >= 1.1"

ENTRYPOINT ["uvicorn", "app.main:app", "--host", "0.0.0.0", "--port", "9133"]
